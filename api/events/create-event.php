...
try {
    ...
    $stmt = $conn->prepare(
        "INSERT INTO eventos (title, short_description, date, category, category_label,
    ...
    $action = 'EVENTO_CREATED';
    $details = "Evento creado: ID $eventoId - $title";
    ...
    echo json_encode(['success' => true, 'message' => 'Evento creado exitosamente', 'id' => $eventoId], JSON_UNESCAPED_UNICODE);
